...
- notifies users of Change of Tenancy events (from DCC to use via webhook)
...
- new controller/user terms can be automatically discovered and assest in realtime.
...
<Note>The Data Provider maintains its own independant relationship with the Data User, it may choose to use the Verification mechanism described here **OR** to trust the Data User based on their own technical & commercial controls</Note>
