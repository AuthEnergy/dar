...
<Note>The Data Provider maintains its own independant relationship with the Data User, it may choose to use the Verification mechanism described here **OR** to trust the Data User based on their own commercial controls</Note>
